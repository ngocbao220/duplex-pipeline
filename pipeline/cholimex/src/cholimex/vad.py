"""Purpose: Produce and persist Cholimex VAD masks.

Inputs: Provisional speaker waveforms and VAD thresholds.
Outputs: Activity segments plus JSON and text debug artifacts.
"""
...
def run_silero_vad(
    ...
    kwargs["speech_pad_ms"] = max(0, int(padding_ms))
    if min_duration > 0:
