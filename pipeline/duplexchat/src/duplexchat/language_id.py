...
def load_whisper_lid_model(
    ...
    try:
        ...
        raise RuntimeError(
            f"Failed to load Transformers Whisper LID model from '{local_target}'. "
            "Ensure the local Transformers model files are present and the "
            "DuplexChat runtime dependencies are installed. "
